...
TARGET_VERSION = "102.1"
OUTPUT_NAME = "bot_wallapop_profesional_v102_1_ADMIN_ROTACION_REAL.py"
...
def _hotfix_rotacion_real_v102_1(texto):
    """
    V102.1: la prueba ya localiza el candidato; este hotfix hace que la
    rotación REAL borre desde la tarjeta de Productos antes de usar el flujo
    antiguo de detalle.
    """
    if "V102.1 · BORRADO REAL DESDE PRODUCTOS" in texto:
        return texto

    codigo = r'''

# =========================================================
# V102.1 · BORRADO REAL DESDE PRODUCTOS
# =========================================================
        ...
        with sync_playwright() as p:
            ...
            if not ok:
                ...
                try:
                    ...
                    _v102_log_rotacion(
                        "V102.1 diagnóstico exacto guardado en "
                        + str(
                            diag
                        )
                    )
...
def _v102_eliminar_en_wallapop(candidato):
    _v102_log_rotacion(
        "V102.1: intentando borrado real desde Productos."
    )
...
def construir_v102(fuente_path, texto):
...
def main():
    ...
    nuevo = construir_v102(fuente, texto)
    ...
    try:
        ...
        try:
            ...
            messagebox.showerror(
                "DIAGPROG5 · Actualización V102.1",
